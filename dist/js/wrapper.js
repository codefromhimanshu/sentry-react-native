...
export const NATIVE = {
    ...
    sendEvent(event) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (NATIVE.platform === "android") {
                ...
                const payload = JSON.stringify(Object.assign(Object.assign({}, event), { message: {
    ...
    addBreadcrumb(breadcrumb) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-unsafe-member-access
        RNSentry.addBreadcrumb(Object.assign(Object.assign({}, breadcrumb), { data: breadcrumb.data
